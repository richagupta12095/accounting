<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'City','name'=>'city','type'=>'text','width'=>'col-sm-10','dataenum'=>'Active;In-Active'];
			$this->form[] = ['label'=>'Pincode','name'=>'pincode','type'=>'text','width'=>'col-sm-10'];
		
			$this->form[] = ['label'=>'Region','name'=>'state','type'=>'select2','width'=>'col-sm-10','datatable'=>'state,StateName'];
			
			$this->form[] = ['label'=>'Qualification','name'=>'qualification','type'=>'select','width'=>'col-sm-10','datatable'=>'qualification,qualification'];
			$this->form[] = ['label'=>'Photo','name'=>'photo','type'=>'upload','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'Privileges','name'=>'id_cms_privileges','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_privileges,name',"datatable_where"=>"id=2"];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'Attendance','url'=>CRUDBooster::mainpath('set-attandance/accountant/[id]'),'icon'=>'fa fa-watch','color'=>'info'];
		   ...
		   $this->table_row_color[] = ["condition"=>"[status] == 'In-Active'","color"=>"warning"];
	        ...
	        |
	        */
	       $this->index_statistic[] = ['label'=>'Total Active Accountant','count'=>DB::table($this->table)->where('id_cms_privileges',2)->where('status','Active')->count(),'icon'=>'fa fa-user','color'=>'green','width'=>'col-sm-3'];

			$this->index_statistic[] = ['label'=>'Total In-Active Accountant','count'=>DB::table($this->table)->where('id_cms_privileges',2)->where('status','In-Active')->count(),'icon'=>'fa fa-user','color'=>'red','width'=>'col-sm-3'];
	        ...
	        */
	        ...
	        |
	        */
	        $this->load_js = array('https://cdn.jsdelivr.net/npm/vue/dist/vue.js');
