<?php namespace App\Http\Controllers;
	...
	class AdminLocationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"User Name","name"=>"userId","join"=>"cms_users,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'User Name','name'=>'userId','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name'];
