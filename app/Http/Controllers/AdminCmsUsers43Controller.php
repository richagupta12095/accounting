<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers43Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Sponsor Id","name"=>"sponsorId"];
			...
			$this->form[] = ['label'=>'Sponsor Id','name'=>'sponsorId','type'=>'text','validation'=>'min:1|max:10|unique:cms_users','width'=>'col-sm-10','placeholder'=>'Please enter a valid sponsorId'];
			...
			$this->form[] = ['label'=>'Dob','name'=>'dob','type'=>'date'];
