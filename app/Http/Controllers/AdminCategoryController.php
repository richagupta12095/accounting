<?php namespace App\Http\Controllers;
	...
	class AdminCategoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Parent Category","name"=>"parentId","join"=>"category,category"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Category','name'=>'category','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Slug','name'=>'slug','type'=>'text','width'=>'col-sm-10'];
			
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Parent Category','name'=>'parentId','type'=>'select2','width'=>'col-sm-10','datatable'=>'category,category'];
			...
			//$this->form[] = ['label'=>'Slug','name'=>'slug','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Parent Category','name'=>'parentId','type'=>'select2','width'=>'col-sm-10'];
			# OLD END FORM
	    ...
	    */
	    public function hook_before_edit(&$postdata,$id) {
			...
			if(empty($postdata['image'])){
						...
						$img =DB::table('category')->select('image')->where('id', $id)->get()->toArray();

						$postdata['image']=$img[0]->image;
